.data
	...
	oddMsg: .asciiz" are odd Numbers in the Array."
	errorMsg: .asciiz"There is no odd number in the Array."
.text
main:
	#print string Size
	li $v0,4
	...
	printLoop:		
		...
		bnez $s4, printODD #if reminder==0,then even #for finding Odd numbers, here beqz will be replaced with bnez 
