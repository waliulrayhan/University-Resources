...
int main()
{
    ...
    // making arrival time 0 for all processes
    for (i = 0; i < n; i++)
    {
        arrival_time[i] = 0;
    ...
    cout << endl;
    cout << "-----------------------------------" << endl;
    cout << "Sequence of execution is ( Gantt Chart )" << endl;
    for (i = 0; i < n; i++)
    {
    ...
    for (i = 0; i < n; i++)
    {
        cout << "P" << i << "     |      " << burst_time[i] << "       |      " << waiting_time[i] << "        |       " << turn_around_time[i] << endl;
    }
    cout << endl;
    for (i = 0; i < n; i++)
    {
    ...
    cout << "-------------------------------------------------------------" << endl;
    cout << "Average waiting time " << av2 / n << "ms" << endl
         << "Average turnaround time(s) " << av1 / n << "ms" << endl;
    cout << "-------------------------------------------------------------" << endl;
